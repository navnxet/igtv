<main>
    <div class="container py-lg-md d-flex">
        <div class="col px-0">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="display-3 "><?php language('_DOWNLOADPOST'); ?></h1>
                    <div class="form-group">
                        <label><?php language('_PLACEHOLDER1'); ?></label>
                        <input type="url" id="input" name="input" class="form-control" placeholder="<?php language('_PLACEHOLDER1'); ?>">
