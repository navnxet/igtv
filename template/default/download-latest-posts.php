<main>
    <div class="container py-lg-md d-flex">
        <div class="col px-0">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="display-3 "><?php language('_DOWNLOADLATESTPOSTS'); ?></h1>
                    <div class="form-group">
                        <label><?php language('_PLACEHOLDER6'); ?></label>
                        <input type="url" id="input" name="input" class="form-control" placeholder="<?php language('_PLACEHOLDER6'); ?>">
                        <input type="hidden" name="action" id="action" value="profile">
                        <input type="hidden" name="json" id="json" value="">
                        <input type="hidden" name="token" id="token" value="<?php echo $_SESSION['token']; ?>">
                        <button id="btnDownloadLatestPosts" class="btn btn-default btn-block mt-3">
